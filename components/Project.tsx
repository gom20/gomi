    ...
    const works = [
        ...
        },
        {
            ...
            desc:
                ...
                '기존에 실측 사용량 생성 로직의 비효율성을 개선하기 위한 재개발 프로젝트이며, 재개발에 따른 타 Application 영향도 분석 및 수정을 진행을 진행하였습니다. ' +
        ...
        },
        {
            ...
            desc:
                ...
                '소스 시스템에서 센서 데이터를 I/F 받아 여러 단계에 거쳐 최종적으로 자재 별 사용량과 원단위 데이터를 산출하는 것이 목적입니다. ' +
        ...
        },
        {
            ...
            desc:
                ...
                '주요 업무 내용으로는 Customer 모듈의 REST API와 화면 개발을 담당하였습니다. 그리고 Admin(사용자, 로그인, 메뉴) 모듈을 유지보수 하였습니다. ' +
                'Spring 프레임워크 기반의 REST API 서버를 개발하였으며 이와 함께 웹 화면도 구현하였습니다. ' +
                '화면의 경우 Javascript, jQuery로 조작을 구현하였으며 jqGrid 라이브러리를 사용하여 게시판을 개발하였습니다. ',
        },
        {
            key: 6,
